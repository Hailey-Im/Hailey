		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "주문현황 ",
									"targetURL": "#sdorderlist1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdorderlist1-display": {
								"semanticObject": "sdorderlist1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sdorderlist1",
									"url": sap.ui.require.toUrl("sdorderlist1")
								}
							}
						}
					}
